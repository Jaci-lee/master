...
public class WifiConnect {
        ...
        public boolean connect(String SSID, String Password) {
                WifiCipherType Type = getCipherType(this.mWifiManager, SSID);
                Log.d(TAG, "Type:" + Type + "SSID=" + SSID);
                if (Type == null) {
                        return false;
                }
                if (!this.openWifi()) {
        ...
        public WifiCipherType getCipherType(WifiManager mWifiManager, String ssid) {
        ...
        public void forgetnet(String SSID) {
                if (this.isExsits(SSID) != null) {
                        int netID = this.isExsits(SSID).networkId;
